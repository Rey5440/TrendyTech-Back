                      ...
                      <tr>
                        <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;word-break:break-word;">
                          <div style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;">
                            <p style="line-height: 18px; margin: 10px 0; text-align: center;font-size:14px;color:#ffffff;font-family:'Times New Roman',Helvetica,Arial,sans-serif">PROCESADORES&nbsp; &nbsp; &nbsp; &nbsp;| &nbsp; &nbsp; &nbsp;CELULARES&nbsp; &nbsp; &nbsp; &nbsp;| &nbsp; &nbsp; &nbsp;PERIFERICOS</p>
                          </div>
                        </td>
                      </tr>
                    </tbody>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td align="left" style="font-size:0px;padding:10px 25px;padding-top:5px;padding-bottom:0px;word-break:break-word;">
                          <div style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;">
                            <p style="line-height: 16px; text-align: center; margin: 10px 0;font-size:15px;color:#ffffff;font-family:'Times New Roman',Helvetica,Arial,sans-serif">* Luego de hacer click en "Confirmar", se te redirigirá al inicio de tu cuenta de Trendy Tech.</p>
                          </div>
                        </td>
                      </tr>
                    </tbody>
...
const emailForgetPassword = async (data) => {
  ...
  const info = await transport.sendMail({
    ...
    <p>Hola: ${name}, recupera tu cuenta en Trendy Tech</p>
                <body style="word-spacing:normal;background-color:#F4F4F4;">
                <div style="background-color:#F4F4F4;">
                  <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" bgcolor="#000000" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                  <div style="background:#000000;background-color:#000000;margin:0px auto;max-width:600px;">
                                    ...
                                    <td align="center" style="font-size:0px;padding:0px 25px;padding-right:0px;padding-bottom:0px;padding-left:0px;word-break:break-word;">
                                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                        <tbody>
                                          <tr>
                                            <td style="width:600px;">
                                              <img height="auto" src="https://res.cloudinary.com/dntrwijx5/image/upload/v1696451817/imagenes/qngyd1l9ukozy7j2rigj.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" title="" width="600" />
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tbody>
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:25px;padding-bottom:5px;word-break:break-word;">
                                      <div style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;">
                                        <p style="line-height: 60px; text-align: center; margin: 10px 0;font-size:45px;color:#fcfcfc;font-family:'Times New Roman',Helvetica,Arial,sans-serif">
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tbody>
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:5px;padding-bottom:0px;word-break:break-word;">
                                      <div style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#55575d;">
                                        <p style="line-height: 16px; text-align: center; margin: 10px 0;font-size:15px;color:#ffffff;font-family:'Times New Roman',Helvetica,Arial,sans-serif">* Al hacer click en "Recuperar contraseña", te redirigira a Trendy Tech para que crear una nueva contraseña.</p>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
