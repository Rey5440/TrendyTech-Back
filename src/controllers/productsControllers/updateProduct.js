...
const { validatePrice, validateDescription, validateStock, validateName, validateBrand, validateColor,
    validateType } = require("../../helpers/validationUpdateHelpers")

const updateProduct = async (updateData) => {
    const { id, name, price, description, stock, images, brand, color, type } = updateData
